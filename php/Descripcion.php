    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        try {
            ...
            if ($datos_existentes) {
                ...
                $sql_actualizar = "UPDATE datos_empresa SET nombre_comercial = :nombre_comercial, correo_electronico = :correo_electronico, telefono = :telefono, ubicacion = :ubicacion, descripcion = :descripcion WHERE registro_id = :registro_id";
                ...
                $sql_insertar = "INSERT INTO datos_empresa (registro_id, nombre_comercial, correo_electronico, telefono, ubicacion, descripcion)         
                VALUES (:registro_id, :nombre_comercial, :correo_electronico, :telefono, :ubicacion, :descripcion)";
